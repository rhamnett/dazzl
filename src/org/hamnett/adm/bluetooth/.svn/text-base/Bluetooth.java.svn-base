...
{
    static final String ENABLED_PREFERENCE = "bluetooth.enabled";
    static final String DEVICE_ADDRESS_PREFERENCE = "bluetooth.deviceAddress";
    static final String REDIRECT_EXTENSION_PREFERENCE = "bluetooth.redirectExtension";
