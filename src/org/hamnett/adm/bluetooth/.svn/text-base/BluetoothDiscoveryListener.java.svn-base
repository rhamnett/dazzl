...
{
    /**
     * Called when discovery has completed.
     * 
     * @param result contains the result of this discovery, that is the devices
     *            that were found.
     */
    void discoveryFinished(BluetoothDiscoveryResult result);
}
