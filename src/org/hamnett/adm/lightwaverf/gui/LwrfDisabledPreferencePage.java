...
public class LwrfDisabledPreferencePage extends PreferencePage
{
    public LwrfDisabledPreferencePage()
    {
        setDescription(Messages
                .getString("CrmDisabledPreferencePage.description")); //$NON-NLS-1$
    }
